    ...
    >
      ...
      >
        <svg
          ...
          y="0px"
          viewBox="0 0 64 64"
          className={"h-[0.75rem] w-auto fill-axolotl"}
        >
...
export const Navbar = ({ invert }: { invert: number }) => {
  ...
  return (
    <>
      ...
      />
      <section
        className={`fixed z-30 w-[92vw] px-[2vw] pb-[1.25vh] top-[2vh] flex justify-between items-center border-b-[0.25vh] border-white`}
      >
