...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={
          "w-full h-full md:h-max md:my-auto flex flex-col md:flex-row justify-center md:justify-between items-center gap-[4vh] md:px-[2vw]"
        }
      >
        <div
          className={
        ...
        <form
          action={async (formData) =>
            await submit({ formData: formData, dialCode: code })
          }
          className={
            "w-full md:w-[56vh] flex flex-col justify-center items-start containerize md:px-[2vw] bg-white gap-[2vh] md:gap-[4vh] py-[2vh] md:py-[4vh]"
          }
        >
          <Input
            label={"Name"}
                  ...
                  >
                    {codes.map((sel, index) => (
                      ...
                      >
                        ...
                        <span className={"text-black/50"}>{sel.dial_code}</span>
                      </button>
                    ))}
                  </div>
                )}
            ...
            >
              <ModalContent>
                <>
                  ...
                  <ModalBody>
                    <p>
                      Aequea adolescens viderer graece eleifend laudem accusata
                      nunc saperet possim. Euaptent molestie ultricies inimicus
                      impetus nam imperdiet posidonium praesent duis dictumst
                      ridens tacimates porta. Loremleo discere utinam ante
                      qualisque euripidis interesset alienum quam gravida eum
                      accommodare mi utroque quod aliquet magna. Accusatamorbi
                      tacimates sit sodales no tellus pulvinar.
                      Vulputatefabellas quot saperet scelerisque graece deserunt
                      sapien salutatus homero deserunt dicunt homero pericula
                      proin libero singulis explicari mnesarchum.
                      Quamdissentiunt ubique quaerendum animal tristique in
                      blandit mea eam te audire scelerisque.
                    </p>
                  </ModalBody>
                  <ModalFooter>
                    <Button
                ...
                <>
                  ...
                  <ModalBody>
                    <p>
                      ...
                      Mandamusdocendi magnis a cum veritus dicam simul solet mei
                      habemus. Repudiandaedeseruisse scripta adolescens
                      ...
                      gloriatur dicant wisi hac iusto invidunt noster maiestatis
                      sociis eripuit viris. Pulvinarwisi usu an elit verterem
                      sapien tota fastidii delicata brute cras intellegat error
                      congue eos necessitatibus dico posse.
                    </p>
                  </ModalBody>
                  <ModalFooter>
                    <Button
